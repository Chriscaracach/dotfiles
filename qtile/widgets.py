...
# Every bar needs its OWN widget instances - a widget object cannot be shared
# between two bars. init_widgets_list() therefore builds a fresh set on each
# call, one per Screen.

# Registry so keyboard_utils can push a layout change to every bar's indicator.
keyboard_widgets = []


def init_widgets_list():
    """Build and return a fresh set of bar widgets."""
    ...
    keyboard_widgets.append(keyboard_widget)
